...
def MNIST(data_path, batch_size, shuffle=True, train=True, condition_on=None, num_workers=0, rescale_to=29, holdout=False):
	...
	if condition_on is not None:
		...
		if not holdout:
			...
			train_dataset = torch.utils.data.DataLoader(dataset, sampler=tr_sampler, batch_size=512, shuffle=False, num_workers=num_workers)
			anomaly_dataset = torch.utils.data.DataLoader(dataset, sampler=an_sampler, batch_size=512, shuffle=False, num_workers=num_workers)
			print("====================")
